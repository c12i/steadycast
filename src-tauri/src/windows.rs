...
pub fn open_preview_window(app: AppHandle) -> Result<(), String> {
    ...
    WebviewWindowBuilder::new(&app, "stream-preview", WebviewUrl::App("index.html#/preview".into()))
...
pub fn open_logs_window(app: AppHandle) -> Result<(), String> {
    ...
    WebviewWindowBuilder::new(&app, "ffmpeg-logs", WebviewUrl::App("index.html#/logs".into()))
        .title("FFmpeg Logs")
